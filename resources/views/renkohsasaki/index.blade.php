    ...
    <div class="container text-center">
        ...
        <div class="d-block d-md-none">
            ...
            <div style="margin-top:100px; margin-bottom:250px">
                <img src="{{ asset($first_web_image) }}" class="img-responsive" style="width:100%;">
            </div>
            @else
            <div style="margin-top:100px; margin-bottom:250px">
        ...
        <div class="d-none d-md-block">
            ...
            <div style="margin-top:72px; margin-bottom:30px;">
                <img src="{{ asset($first_web_image) }}" class="img-responsive" style="max-height:700px; max-width:100%;">
            </div>
            @else
            <div style="margin-top:72px; margin-bottom:30px;">
        ...
        <div class="d-none d-md-block">
            ...
            <div style="margin-top:300px; margin-bottom:200px">
                <img src="{{ asset($web_image) }}" class="img-responsive" style="max-height:700px; max-width:100%">
            </div>
            @else
            <div style="margin-top:300px; margin-bottom:200px">
